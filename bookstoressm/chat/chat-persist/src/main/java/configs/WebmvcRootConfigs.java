...
import dao.ChatDAO;
import manager.ChatManagerImp;
import service.ChatServiceImp;
...
@Configuration
@MapperScan(basePackageClasses= {ChatDAO.class})
@ComponentScan(basePackageClasses= {ChatServiceImp.class,ChatManagerImp.class},
	excludeFilters= {
